		...
		<div class="fusion-page-title-wrapper">
			<div class="fusion-page-title-captions">
				...
				<?php if ( $title ) : ?>
					...
					<?php if ( is_product_category ('572')) { ?>
						<h1 class="<?php echo esc_attr( $entry_title_class ); ?>">Catalogue de nos produits pour Huissiers de Justice</h1>
					<?php } else if ( is_product_category ('571')) { ?>
						<h1 class="<?php echo esc_attr( $entry_title_class ); ?>">Catalogue de nos produits pour Avocats</h1>
					<?php } else { ?>	
